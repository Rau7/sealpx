    ...
    >
      <div className="container px-4 mx-auto">
        <div className="mb-8 md:mb-16 md:max-w-5xl">
          ...
          <h3 className="mb-4 text-3xl md:text-5xl leading-tight text-white font-bold tracking-tighter">
        ...
        <ul className="flex flex-wrap mb-8 -mx-2 text-center">
          <li className="w-full md:w-auto px-2">
            <a
              className="inline-block w-full py-2 px-4 mb-4 md:mb-0 text-sm text-coolGray-600 hover:text-green-900 hover:bg-green-200 font-bold rounded-md hover:shadow-sm"
              href="#"
            >
              All Categories
            </a>
          ...
          <li className="w-full md:w-auto px-2">
            <a
              className="inline-block w-full py-2 px-4 text-sm text-coolGray-600 hover:text-green-900 hover:bg-green-200 font-bold rounded-md hover:shadow-sm"
              href="#"
            >
              Start-up
            </a>
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/effect3.jpg" alt />
              </a>
            </div>
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/work3.jpg" alt />
              </a>
            </div>
            <div className="w-full md:flex-1 md:px-4">
              <a
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/work4.jpg" alt />
              </a>
            </div>
            <div className="w-full md:flex-1 md:px-4">
              <a
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/effect4.jpg" alt />
              </a>
            </div>
            <div className="w-full md:flex-1 md:px-4">
              <a
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 xl:mb-0 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/learn2.jpg" alt />
              </a>
            </div>
            <div className="w-full md:flex-1 md:px-4">
              <a
          ...
          <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 md:-mx-4">
            <div className="w-full md:w-auto md:px-4">
              <a
                ...
                href="#"
              >
                <img src="assets/images/blog/macbook2.jpg" alt />
              </a>
            </div>
            <div className="w-full md:flex-1 md:px-4">
              <a
        ...
        <div className="flex justify-center mx-auto max-w-max bg-coolGray-800 border border-coolGray-700 rounded-md shadow-lg">
          <a
            className="inline-flex items-center justify-center w-11 h-11 text-coolGray-500 hover:text-coolGray-600 font-medium border-r border-coolGray-700"
            href="#"
          >
            <svg
              width={8}
          ...
          <a
            className="inline-flex items-center justify-center w-11 h-11 text-coolGray-500 hover:text-green-500 font-medium border-r border-coolGray-700"
            href="#"
          >
            1
          </a>
          ...
          <a
            className="inline-flex items-center justify-center w-11 h-11 text-coolGray-500 hover:text-coolGray-600 font-medium"
            href="#"
          >
            <svg
              width={8}
